...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Restaurant.modified_ip'
        db.add_column(u'venues_restaurant', 'modified_ip',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=39),
                      keep_default=False)

        # Adding field 'Masjid.modified_ip'
        db.add_column(u'venues_masjid', 'modified_ip',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=39),
                      keep_default=False)

        # Adding field 'Comment.modified_ip'
        db.add_column(u'venues_comment', 'modified_ip',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=39),
                      keep_default=False)

        # Adding field 'Note.modified_ip'
        db.add_column(u'venues_note', 'modified_ip',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=39),
                      keep_default=False)

        # Adding field 'HistoricalRestaurant.modified_ip'
        db.add_column(u'venues_historicalrestaurant', 'modified_ip',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=39),
                      keep_default=False)

        # Adding field 'HistoricalMasjid.modified_ip'
        db.add_column(u'venues_historicalmasjid', 'modified_ip',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=39),
                      keep_default=False)

        # Adding field 'Report.modified_ip'
        db.add_column(u'venues_report', 'modified_ip',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=39),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Restaurant.modified_ip'
        db.delete_column(u'venues_restaurant', 'modified_ip')

        # Deleting field 'Masjid.modified_ip'
        db.delete_column(u'venues_masjid', 'modified_ip')

        # Deleting field 'Comment.modified_ip'
        db.delete_column(u'venues_comment', 'modified_ip')

        # Deleting field 'Note.modified_ip'
        db.delete_column(u'venues_note', 'modified_ip')

        # Deleting field 'HistoricalRestaurant.modified_ip'
        db.delete_column(u'venues_historicalrestaurant', 'modified_ip')

        # Deleting field 'HistoricalMasjid.modified_ip'
        db.delete_column(u'venues_historicalmasjid', 'modified_ip')

        # Deleting field 'Report.modified_ip'
        db.delete_column(u'venues_report', 'modified_ip')
    ...
    models = {
        ...
        u'venues.comment': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified_ip': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '39'}),
