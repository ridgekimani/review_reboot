...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Restaurant.slug'
        db.add_column(u'venues_restaurant', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='', max_length=50),
                      keep_default=False)

        # Adding field 'Masjid.slug'
        db.add_column(u'venues_masjid', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='', max_length=50),
                      keep_default=False)

        # Adding field 'HistoricalRestaurant.slug'
        db.add_column(u'venues_historicalrestaurant', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='', max_length=50),
                      keep_default=False)

        # Adding field 'HistoricalMasjid.slug'
        db.add_column(u'venues_historicalmasjid', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Restaurant.slug'
        db.delete_column(u'venues_restaurant', 'slug')

        # Deleting field 'Masjid.slug'
        db.delete_column(u'venues_masjid', 'slug')

        # Deleting field 'HistoricalRestaurant.slug'
        db.delete_column(u'venues_historicalrestaurant', 'slug')

        # Deleting field 'HistoricalMasjid.slug'
        db.delete_column(u'venues_historicalmasjid', 'slug')
