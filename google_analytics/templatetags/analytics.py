...
register.tag('approved', do_get_analytics)
register.tag('moderate', do_get_analytics)
register.tag('all_note', do_get_analytics)
register.tag('profile', do_get_analytics)
register.tag('review', do_get_analytics)
register.tag('restaurant', do_get_analytics)
register.tag('updated', do_get_analytics)
register.tag('login', do_get_analytics)
register.tag('addrestaurantdo', do_get_analytics)
register.tag('allreview', do_get_analytics)
